...
const technologies = [
  ...
  { name: "Salesforce", icon: "https://banner2.cleanpng.com/20180712/lpe/aaw8929hy.webp", dark: true },
  ...
  { name: "Java", icon: "https://banner2.cleanpng.com/20180710/yfj/aawrirzz9.webp" },
...
const Tech = () => {
  ...
  return (
    <>
    <Helmet>
        <title>My Skills | Portfolio - Ujjawal</title>
    </Helmet>
