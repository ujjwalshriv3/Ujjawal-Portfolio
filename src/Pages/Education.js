...
const educationData = [
  {
    date: "2021 - 2025",
    cname: "Maharshi Dayanand University, Rohtak",
    title: "MERI college of engineering",
    iconBg: "#fff",
    icon: college,
    points: [
      "College: MERI-CET",
  ...
  },
  {
    ...
    cname: "Holy Convent Senior Secondary School, Delhi",
  ...
  },
  {
    ...
    cname: "Central Public School, Uttar Pradesh",
    ...
    points: [
      "Board: Central Board of Secondary Education, New Delhi",
      "Percentage - 92%",
      "Achive Citation for Excellency in Class 10th.",
      "Taking Part in Many Competitions (Educational/Cultural)",
    ],
  },
  {
    date: "April 2006 - March 2014",
    cname: "Oxford Public School, Uttar Pradesh",
...
const Education = () => {
  ...
  return (
    <>
    <Helmet>
        <title>My Education | Portfolio - Ujjawal</title>
    </Helmet>
