...
import dp from "../AssetPic/img2.png";
    ...
    <div style={flexLeft.container}>
      ...
      <div style={flexLeft.details}>
        <motion.div
          ...
          animate="show"
        >
          <div style={{ ...flexLeft.name, fontFamily: "'Tangerine', cursive", }}>Ujjawal Shrivastava</div>
        </motion.div>
        <motion.div
          ...
          animate="show"
        >
          <h3 style={flexLeft.greyFont}>Ujjwalshriv3</h3>
        </motion.div>
        <motion.div
        ...
        >
          <div style={flexLeft.desc}>
            Btech-CSE 25' @MDU | FullStack Web Developer | Learner | Ai Enthusiast
          </div>
        </motion.div>
        <motion.div
        ...
        >
          <div className="glowbtn">
            <a
              href="https://drive.google.com/file/d/1FSn4Er9NH-Qs4ZwZu1ZHWFyMP2Pm4s1K/view?usp=sharing" target="_blank" rel="noopener noreferrer"
              onClick={playSound}
              style={{
                padding: "12px 60px",
                borderRadius: "10px",
      ...
      <div style={flexLeft.socials}>
        <ul className="social-icons" style={flexLeft.socialIcons}>
          ...
          >
            <li>
              <a
                href="https://www.linkedin.com/in/ujjawal-shrivastava-81a384218"
          ...
          >
            <li>
              <a
                href="https://github.com/ujjwalshriv3"
          ...
          >
            <li>
              <a
                href="mailto:ujjawalshrivastava69@gmail.com"
          ...
          >
            <li>
              <a
                href="https://x.com/ujjawal_shri123"
