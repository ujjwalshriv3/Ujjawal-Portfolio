...
export default function AboutCards() {
  ...
  const skills = {
    ...
    description: "",
    points: ["React, ","Javascript, ","Python, ","Django, ","Tailwind, ","java, ","html, ","MySql, ","ExpressJs, ","Others... ",],
    content: [],
  };
  ...
  const certifications = {
    ...
    description: "",
    points: ["GSsoc Appreciation, ", "Ai certification, ", "IBM skills Interns Certifications ,", "Salesforce Developer Certification, ","Postman API, ", "Others..."],
    content: [],
  };
  ...
  const achievements = {
    ...
    description: "",
    points: ["Branch Topper, ", "Tech & Github Advocate, ", "GSsoc Ranker, ", " Class Topper, ","Others..."],
    content: [],
  };
