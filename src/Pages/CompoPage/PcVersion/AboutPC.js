        ...
        >
          ...
          <div className="box-container">
            ...
            <div className="box">
              ...
              <span  style={{color: '#ff00ff', fontFamily: "'Vidaloka', serif", fontWeight: 500, marginTop: '1rem'}}> Hobbies : </span> Cricket, Writing, Try to Learn New Skills, Travelling, Listenig Music, Playing Football</p>
              </motion.div>
...
// // Using the React logo from public folder
...
//             animate="show"
//         >
//           <h3 style={{fontFamily: "'Great Vibes', cursive", color: '#ffffff', fontSize: '4rem'}}>I'm Ujjawal Shrivastava</h3>
//           <span style={{
...
//                 lineHeight: 1.7,
//               }}>
//                 I am Ujjawal, an IT Engineering student passionate about computers and aiming to kickstart a career in Software Development and Web Development. Currently based in Delhi, India, I am pursuing my undergraduate studies in Information Technology at GGSIPU. My enthusiasm lies in enhancing my coding abilities and crafting applications and websites. As Well-organised & collaborative individual,<br/> I thrive in team environemnts and enjoy bringing inovative solutions to table.<br/><br/> Awesome!! Let's Build the Next Big Thing...
//           </p>
//           </motion.div>
...
//               <p><i className="bi bi-telephone-fill" style={{ fontSize: '1.7rem', color: '#ff00ff', marginRight: '0.5rem' }}></i>
//               <span  style={{color: '#ff00ff', fontFamily: "'Vidaloka', serif", fontWeight: 500, marginTop: '1rem'}}> Phone : </span>
//               <a href="tel:+8743917011" target="_blank" rel="noopener noreferrer" style={{ color: '#fcfcfc' }}>+91 97178-99079</a></p>
//               <p><i className="bi bi-cake-fill" style={{ fontSize: '1.7rem', color: '#ff00ff', marginRight: '0.5rem' }}></i>
...
//               <p><i className="bi bi-envelope-at-fill" style={{ fontSize: '1.7rem', color: '#ff00ff', marginRight: '0.5rem' }}></i>
//               <span  style={{color: '#ff00ff', fontFamily: "'Vidaloka', serif", fontWeight: 500, marginTop: '1rem'}}> Email : </span>
//               <a href="mailto:Ujjawalsaini0007@gmail.com" target="_blank" rel="noopener noreferrer" style={{ color: '#fcfcfc' }}>Ujjawalsaini0007@gmail.com</a></p>
//               <p><i className="bi bi-geo-alt-fill" style={{ fontSize: '1.7rem', color: '#ff00ff', marginRight: '0.5rem' }}></i>
