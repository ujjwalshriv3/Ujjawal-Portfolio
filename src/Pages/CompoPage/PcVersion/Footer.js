  ...
  return (
    <footer style={footerStyles}>
      <div style={leftSectionStyles}>
        <img src={UsLogo} alt="UjjawalS Portfolio Logo" onClick={playSound1} ref={ref0} style={logoStyles} />
        <div style={paragraphContainerStyles}>
          <h3 ref={ref0} style={boxHeadingStyles} onClick={() => { playSound1(); handleScrollToTop(); }}>Ujjawal Portfolio</h3>
