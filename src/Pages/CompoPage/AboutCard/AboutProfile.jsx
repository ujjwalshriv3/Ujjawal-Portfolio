...
import dp from "../AssetPic/Img3.png";
  ...
  return (
    <div style={flexLeft.container}>
      ...
      <div style={flexLeft.details}>
        <div ref={ref1} style={{ ...flexLeft.name, opacity: inView1 ? 1 : 0, transform: inView1 ? 'translateY(0)' : 'translateY(-50px)', transition: `opacity 1.25s ease-out 1.1s, transform 1.25s ease-out 1.1s`, fontFamily: "'Tangerine', cursive", }}>Ujjawal Shrivastava</div>
        <h3 ref={ref1} style={{ ...flexLeft.greyFont, opacity: inView1 ? 1 : 0, transform: inView1 ? 'translateY(0)' : 'translateY(-50px)', transition: `opacity 1.25s ease-out 1.8s, transform 1.25s ease-out 1.8s` }}>ujjwalshriv3</h3>
        <div ref={ref1} style={{ ...flexLeft.desc, opacity: inView1 ? 1 : 0, transform: inView1 ? 'translateY(0)' : 'translateY(-50px)', transition: `opacity 1.25s ease-out 2.4s, transform 1.25s ease-out 2.4s` }}>
          BTech-CSE' @MDU | FullStack Web Developer | Open Source | Learner | Tech Enthusiast | Software Developer |  AI Enthusiast | Salesforce Developer 
        </div>
        <div className="glowbtn">
          <a href="https://github.com/ujjwalshriv3"
            onClick={playSound}
            ref={ref1}
            style={{
              padding: '12px 60px',
              ...
              transition: 'opacity 1.25s ease-out 3s, transform 1.25s ease-out 3s, background-color 0.3s'
            }}>
            <span></span>
            <span></span>
            <span></span>
