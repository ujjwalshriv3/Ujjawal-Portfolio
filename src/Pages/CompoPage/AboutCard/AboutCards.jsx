...
export default function AboutCards() {
  ...
  const education = {
    ...
    points: ["Engineering College, MERI-CET-25, ", "CSE"],
    content: [],
  };
  ...
  const skills = {
    ...
    description: "",
    points: ["React, ","Javascript, ","Python, ","Django, ","HTML, ","CSS, ","java, ","AI, ","NodeJs, ","ExpressJs, ","Others... ",],
    content: [],
  };
  ...
  const certifications = {
    ...
    description: "",
    points: ["GSsoc Appreciation, ", "Salesforce Developer, ", "Accenture certifications, ", "IBM Skill build Internship certifications, ","Postman API, ", "Others..."],
    content: [],
  };
  ...
  const achievements = {
    ...
    description: "",
    points: ["Branch Topper, ", "Tech & Github Advocate, ", "GSsoc Ranker, ", "College Ranker, ","Others..."],
    content: [],
  };
